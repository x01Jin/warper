...
You run Windows with Cloudflare WARP installed from the official download page. Approve an admin prompt for connect and reset steps. The app stores its settings next to the exe when that folder allows writes, else in the normal app data folder.
